...
<!-- Navigator bar -->
    ...
    <div class="container-fluid bg-dark position-relative shadow ">
        ...
        <div class="title-heading-w3 text-center mx-auto my-4 mb-5 pb-sm-4">
            <h3 class="title-main"><span>Touch with Us</span></h3>
        </div>
        <div class="container  my-2 ">
            <img class="img-round-all" src="img/Contact-Us.jpg" alt="about us" style="width: 100%; height: 300px">
        </div>
                            ...
                            <div class="cont-details">
                                <div class="d-flex contact-grid">
                                    ...
                                    <div class="cont-right">
                                        ...
                                        <h6><?php echo $row['centre_name']; ?></h6>
                                        <p><?php echo $row['centre_address']; ?></p>
                                        <p><?php echo $row['centre_phone']; ?></p>
                                        <p><?php echo $row['centre_email']; ?></p></br>
                                        <hr>
                                        <?php } ?>
