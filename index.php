...
<!--Slider Image-->
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item active">
      <img style="width: 1530px; height: 450px;" src="women.jpg" alt="Second slide">
    </div>
    <div class="carousel-item active">
      <img style="width: 1530px; height: 450px;" src="man.jpg" alt="Third slide">
    </div>
  </div>
...
<!-- Slider
 <div class="carousel-inner">
      <div class="item active">
        <img src="image\ph.jpg"  alt="Los Angeles" style="width:100%;">
      </div>

      <div class="item">
        <img src="image\pic6.jpg" alt="Chicago" style="width:100%;">
      </div>
    
      <div class="item">
        <img src="image\pic9.jpg" alt="New york" style="width:100%;">
      </div>
    </div>
...
<div class="container">
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="item active">
        <img src="mall.jpg" alt="Los Angeles" style="width:100%;">
      ...
      <div class="item">
        <img src="man.jpg" alt="Chicago" style="width:100%;">
        <div class="carousel-caption">
          <h3>Chicago</h3>
      ...
      <div class="item">
        <img src="women.jpg" alt="New York" style="width:100%;">
        <div class="carousel-caption">
          <h3>New York</h3>
